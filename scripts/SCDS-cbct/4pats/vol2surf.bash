...
cd /stage/sharonxx/proj/mskcc/Patient21/rcct/shape
/home/sharonxx/bin/linux/Vol2surf  -input ./lung-bin-cinePhase$i.mhd  -vtk  -gaussian 9 -label 1 -decimate -targetReduction 2500
echo "done"
